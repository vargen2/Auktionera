...
public class AuctionServiceFilterIntegrationTests {
    ...
    void setUp() {
        ...
        userPrincipal = UserPrincipal.create(accountEntity);
...

        {
            ...
            auctionService.createAuction(userPrincipal, en_bra_stol);
        }
        {
            ...
            auctionService.createAuction(userPrincipal, request);
        }
